...
data=json.loads((root/'data/release-268/index.json').read_text(encoding='utf-8'))
errors=[]
if data.get('release')!=268:errors.append('release mismatch')
...
print('Release 268 validation passed.')
