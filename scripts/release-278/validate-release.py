...
data=json.loads((root/'data/release-278/index.json').read_text(encoding='utf-8'))
errors=[]
if data.get('release')!=278:errors.append('release mismatch')
...
print('Release 278 validation passed.')
