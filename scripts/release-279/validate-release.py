...
data=json.loads((root/'data/release-279/index.json').read_text(encoding='utf-8'))
errors=[]
if data.get('release')!=279:errors.append('release mismatch')
...
print('Release 279 validation passed.')
