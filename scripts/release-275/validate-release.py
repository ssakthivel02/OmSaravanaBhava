...
data=json.loads((root/'data/release-275/index.json').read_text(encoding='utf-8'))
errors=[]
if data.get('release')!=275:errors.append('release mismatch')
...
print('Release 275 validation passed.')
