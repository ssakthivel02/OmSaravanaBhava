...
data=json.loads((root/'data/release-262/index.json').read_text(encoding='utf-8'))
errors=[]
if data.get('release')!=262:errors.append('release mismatch')
...
print('Release 262 validation passed.')
