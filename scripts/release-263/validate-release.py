...
data=json.loads((root/'data/release-263/index.json').read_text(encoding='utf-8'))
errors=[]
if data.get('release')!=263:errors.append('release mismatch')
...
print('Release 263 validation passed.')
