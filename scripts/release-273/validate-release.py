...
data=json.loads((root/'data/release-273/index.json').read_text(encoding='utf-8'))
errors=[]
if data.get('release')!=273:errors.append('release mismatch')
...
print('Release 273 validation passed.')
