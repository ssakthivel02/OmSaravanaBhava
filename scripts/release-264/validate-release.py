...
data=json.loads((root/'data/release-264/index.json').read_text(encoding='utf-8'))
errors=[]
if data.get('release')!=264:errors.append('release mismatch')
...
print('Release 264 validation passed.')
