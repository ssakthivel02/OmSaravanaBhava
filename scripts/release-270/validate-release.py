...
data=json.loads((root/'data/release-270/index.json').read_text(encoding='utf-8'))
errors=[]
if data.get('release')!=270:errors.append('release mismatch')
...
print('Release 270 validation passed.')
