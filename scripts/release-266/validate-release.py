...
data=json.loads((root/'data/release-266/index.json').read_text(encoding='utf-8'))
errors=[]
if data.get('release')!=266:errors.append('release mismatch')
...
print('Release 266 validation passed.')
