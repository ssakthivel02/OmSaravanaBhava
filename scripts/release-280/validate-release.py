...
data=json.loads((root/'data/release-280/index.json').read_text(encoding='utf-8'))
errors=[]
if data.get('release')!=280:errors.append('release mismatch')
...
print('Release 280 validation passed.')
