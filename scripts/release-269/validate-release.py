...
data=json.loads((root/'data/release-269/index.json').read_text(encoding='utf-8'))
errors=[]
if data.get('release')!=269:errors.append('release mismatch')
...
print('Release 269 validation passed.')
