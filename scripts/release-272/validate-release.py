...
data=json.loads((root/'data/release-272/index.json').read_text(encoding='utf-8'))
errors=[]
if data.get('release')!=272:errors.append('release mismatch')
...
print('Release 272 validation passed.')
