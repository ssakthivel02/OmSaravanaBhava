...
data=json.loads((root/'data/release-267/index.json').read_text(encoding='utf-8'))
errors=[]
if data.get('release')!=267:errors.append('release mismatch')
...
print('Release 267 validation passed.')
