...
data=json.loads((root/'data/release-274/index.json').read_text(encoding='utf-8'))
errors=[]
if data.get('release')!=274:errors.append('release mismatch')
...
print('Release 274 validation passed.')
