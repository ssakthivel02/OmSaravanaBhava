...
data=json.loads((root/'data/release-261/index.json').read_text(encoding='utf-8'))
errors=[]
if data.get('release')!=261:errors.append('release mismatch')
...
print('Release 261 validation passed.')
