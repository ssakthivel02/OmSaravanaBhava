...
data=json.loads((root/'data/release-265/index.json').read_text(encoding='utf-8'))
errors=[]
if data.get('release')!=265:errors.append('release mismatch')
...
print('Release 265 validation passed.')
