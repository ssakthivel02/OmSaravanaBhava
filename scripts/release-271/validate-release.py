...
data=json.loads((root/'data/release-271/index.json').read_text(encoding='utf-8'))
errors=[]
if data.get('release')!=271:errors.append('release mismatch')
...
print('Release 271 validation passed.')
