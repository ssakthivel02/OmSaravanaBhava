...
data=json.loads((root/'data/release-277/index.json').read_text(encoding='utf-8'))
errors=[]
if data.get('release')!=277:errors.append('release mismatch')
...
print('Release 277 validation passed.')
